# Fork with Github integration

This is a fork of [codespeed](https://github.com/tobami/codespeed) with 
greatly expanded Github integration. It acts as a Github webhook receiver
and automatically run tests, adding the resulting benchmarking data to
the existing codespeed app.
